...
/**
 * Page "Conseils" qui remplace la Gallery.
...
public class ConseilsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        binding.btnTempsPositifs.setOnClickListener(v -> {
            // Pour l'instant, on ne fait rien (ou un Toast, ou un futur "Temps positifs" fragment)
    ...
    /**
     * Affiche l'overlay en lui assignant un titre et un contenu.
     * On peut y ajouter des images si besoin (ex: binding.imgOverlay.setImageResource(...) ).
     */
